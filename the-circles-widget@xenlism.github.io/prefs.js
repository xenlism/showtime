...
const CirclePrefsWindow = GObject.registerClass(class CirclePrefs extends Gtk.Box {
  setup() {
        ...
        let the_circles_modern_clock_show_label = new Gtk.Label({label: "Show Circle Modern Clock Widget",halign: Gtk.Align.START});
        ...
        this.page1.add(this.boxpack(the_circles_modern_clock_show_label,the_circles_modern_clock_show_switch));

        let the_circles_clock_show_label = new Gtk.Label({label: "Show Circle Clock Widget",halign: Gtk.Align.START});
        ...
        this.page1.add(this.boxpack(the_circles_clock_show_label,the_circles_clock_show_switch));

        let the_circles_digit_clock_show_label = new Gtk.Label({label: "Show Circle digit Clock Widget",halign: Gtk.Align.START});
        ...
        this.page1.add(this.boxpack(the_circles_digit_clock_show_label,the_circles_digit_clock_show_switch));


        let the_circles_cpu_show_label = new Gtk.Label({label: "Show Circle CPU Widget",halign: Gtk.Align.START});
        ...
        this.page1.add(this.boxpack(the_circles_cpu_show_label,the_circles_cpu_show_switch));
        let the_circles_ram_show_label = new Gtk.Label({label: "Show Circle RAM Widget",halign: Gtk.Align.START});
        ...
        this.page1.add(this.boxpack(the_circles_ram_show_label,the_circles_ram_show_switch));
        ...
        let the_circles_clock_digit_label = new Gtk.Label({label: "Show Digit Clock in The Widget",halign: Gtk.Align.START});
        ...
        this.page2.add(this.boxpack(the_circles_clock_digit_label,the_circles_clock_digit_switch));

        let the_circles_clock_am_label = new Gtk.Label({label: "Time Format 12 Hour with AM/PM",halign: Gtk.Align.START});
        ...
        this.page2.add(this.boxpack(the_circles_clock_am_label,the_circles_clock_am_switch));

        let the_circles_clock_color_label = new Gtk.Label({label: "Color of Clock Widget",halign: Gtk.Align.START});
        ...
        this.page2.add(this.boxpack(the_circles_clock_color_label,the_circles_clock_color_button));


        let the_circles_clock_hour_ring_color_label = new Gtk.Label({label: "Color of Hour's Ring",halign: Gtk.Align.START});
        ...
        this.page2.add(this.boxpack(the_circles_clock_hour_ring_color_label,the_circles_clock_hour_ring_color_button));


        let the_circles_clock_min_ring_color_label = new Gtk.Label({label: "Color of Minute's Ring",halign: Gtk.Align.START});
        ...
        this.page2.add(this.boxpack(the_circles_clock_min_ring_color_label,the_circles_clock_min_ring_color_button));

        let the_circles_clock_sec_ring_color_label = new Gtk.Label({label: "Color of Second's Ring",halign: Gtk.Align.START});
        ...
        this.page2.add(this.boxpack(the_circles_clock_sec_ring_color_label,the_circles_clock_sec_ring_color_button));
        let the_circles_clock_frame_optic_label = new Gtk.Label({label: "The Clock Widget Frame transparency",halign: Gtk.Align.START});
        let the_circles_clock_frame_optic_rang = Gtk.HScale.new_with_range(0, 100, 5);
        ...
        this.page2.add(this.boxpack(the_circles_clock_frame_optic_label,the_circles_clock_frame_optic_rang));

        let the_circles_clock_optic_label = new Gtk.Label({label: "The Clock Widget transparency",halign: Gtk.Align.START});
        let the_circles_clock_optic_rang = Gtk.HScale.new_with_range(0, 100, 5);
        ...
        this.page2.add(this.boxpack(the_circles_clock_optic_label,the_circles_clock_optic_rang));

        let the_circles_clock_bg_ring_optic_label = new Gtk.Label({label: "The Clock Widget Background Ring transparency",halign: Gtk.Align.START});
        let the_circles_clock_bg_ring_optic_rang = Gtk.HScale.new_with_range(0, 100, 5);
        ...
        this.page2.add(this.boxpack(the_circles_clock_bg_ring_optic_label,the_circles_clock_bg_ring_optic_rang));
        ...
        let the_circles_cpu_color_label = new Gtk.Label({label: "Color of CPU Widget",halign: Gtk.Align.START});
        ...
        this.page3.add(this.boxpack(the_circles_cpu_color_label,the_circles_cpu_color_button));

        let the_circles_cpu_optic_label = new Gtk.Label({label: "The CPU Widget transparency",halign: Gtk.Align.START});
        let the_circles_cpu_optic_rang = Gtk.HScale.new_with_range(0, 100, 5);
        ...
        this.page3.add(this.boxpack(the_circles_cpu_optic_label,the_circles_cpu_optic_rang));
        ...
        let the_circles_ram_color_label = new Gtk.Label({label: "Color of RAM Widget",halign: Gtk.Align.START});
        ...
        this.page4.add(this.boxpack(the_circles_ram_color_label,the_circles_ram_color_button));

        let the_circles_ram_optic_label = new Gtk.Label({label: "The RAM Widget transparency",halign: Gtk.Align.START});
        let the_circles_ram_optic_rang = Gtk.HScale.new_with_range(0, 100, 5);
        ...
        this.page4.add(this.boxpack(the_circles_ram_optic_label,the_circles_ram_optic_rang));
        ...
        let the_circles_digit_am_label = new Gtk.Label({label: "Time Format 12 Hour with AM/PM",halign: Gtk.Align.START});
        ...
        this.page5.add(this.boxpack(the_circles_digit_am_label,the_circles_digit_am_switch));


        let the_circles_clock_hour_digit_color_label = new Gtk.Label({label: "Color of Hour's digit",halign: Gtk.Align.START});
        ...
        this.page5.add(this.boxpack(the_circles_clock_hour_digit_color_label,the_circles_clock_hour_digit_color_button));


        let the_circles_clock_min_digit_color_label = new Gtk.Label({label: "Color of Minute's digit",halign: Gtk.Align.START});
        ...
        this.page5.add(this.boxpack(the_circles_clock_min_digit_color_label,the_circles_clock_min_digit_color_button));

        let the_circles_clock_sec_digit_color_label = new Gtk.Label({label: "Color of Second's digit",halign: Gtk.Align.START});
        ...
        this.page5.add(this.boxpack(the_circles_clock_sec_digit_color_label,the_circles_clock_sec_digit_color_button));

        let the_circles_clock_ampm_digit_color_label = new Gtk.Label({label: "Color of ampmond's digit",halign: Gtk.Align.START});
        ...
        this.page5.add(this.boxpack(the_circles_clock_ampm_digit_color_label,the_circles_clock_ampm_digit_color_button));

        let the_circles_digit_optic_label = new Gtk.Label({label: "The Clock Widget transparency",halign: Gtk.Align.START});
        let the_circles_digit_optic_rang = Gtk.HScale.new_with_range(0, 100, 5);
        ...
        this.page5.add(this.boxpack(the_circles_digit_optic_label,the_circles_digit_optic_rang));
