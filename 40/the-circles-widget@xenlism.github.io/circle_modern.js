...
const CircleClock = GObject.registerClass(class CircleClockWin extends Gtk.Window {
    _init() {
      ...
      xposition = settings.get_int("the-circles-modern-clock-position-x");
      yposition = settings.get_int("the-circles-modern-clock-position-y");
    ...
    draw(ctx, height, width) {
      ...
      let xe, ye;
        ...
        ctx.setSourceRGBA(settings_clock_color.r, settings_clock_color.g, settings_clock_color.b, settings_clock_frame_transparent);
        ctx.setLineWidth(15);
        ...
        ctx.setSourceRGBA(settings_clock_sec_ring_color.r,settings_clock_sec_ring_color.g,settings_clock_sec_ring_color.b, settings_clock_bg_ring_transparent);
        radius = 80.0;
        ctx.setLineWidth(15);
        ...
        ctx.setSourceRGBA(settings_clock_min_ring_color.r,settings_clock_min_ring_color.g,settings_clock_min_ring_color.b, settings_clock_bg_ring_transparent);
        radius = 60.0;
        ctx.setLineWidth(15);
        ctx.setLineCap(Cairo.LineCap.ROUND);
        ctx.arc(xe, ye, radius, angle1, angle2);
        ...
        ctx.setSourceRGBA(settings_clock_hour_ring_color.r,settings_clock_hour_ring_color.g,settings_clock_hour_ring_color.b, settings_clock_bg_ring_transparent);
        radius = 40.0;
        ctx.setLineWidth(15);
        ctx.setLineCap(Cairo.LineCap.ROUND);
        ctx.arc(xe, ye, radius, angle1, angle2);
        ...
        ctx.setSourceRGBA(settings_clock_sec_ring_color.r,settings_clock_sec_ring_color.g,settings_clock_sec_ring_color.b, settings_clock_transparent);
        radius = 80.0;
        ctx.setLineWidth(15);
        ctx.setLineCap(Cairo.LineCap.ROUND);
        ctx.arc(xe, ye, radius, angle1, angle2);
        ...
        ctx.setSourceRGBA(settings_clock_min_ring_color.r,settings_clock_min_ring_color.g,settings_clock_min_ring_color.b, settings_clock_transparent);
        radius = 60.0;
        ctx.setLineWidth(15);
        ctx.setLineCap(Cairo.LineCap.ROUND);
        ctx.arc(xe, ye, radius, angle1, angle2);
        ...
        // Hour
        let line = Cairo.LineCap.ROUND;
        angle1 = -90.0  * (Math.PI/180.0);
        if (hour == 24 || hour == 12 ) {
          angle1 = -90.0  * (Math.PI/180.0);
          angle2 = 270.0 * (Math.PI/180.0);
          line = Cairo.LineCap.BUTT;
        } else if (hour == 0 ) {
          angle2 = -90.0 * (Math.PI/180.0);
          line = Cairo.LineCap.BUTT;
        } else {
        ...
        ctx.setSourceRGBA(settings_clock_hour_ring_color.r,settings_clock_hour_ring_color.g,settings_clock_hour_ring_color.b, settings_clock_transparent);
        radius = 40.0;
        ctx.setLineWidth(15);
        ctx.setLineCap(line);
        ctx.arc(xe, ye, radius, angle1, angle2);
    ...
    toggleWindowDESKTOPMode() {
      if(this.get_type_hint() == Gdk.WindowTypeHint.NORMAL) {
        this.set_type_hint(Gdk.WindowTypeHint.DESKTOP);
        let win_position = this.get_position();
        settings.set_int("the-circles-modern-clock-position-x",win_position[0]);
        settings.set_int("the-circles-modern-clock-position-y",win_position[1]);
      }
    }
});
...
let settings_clock_frame_transparent = settings.get_int("the-circles-clock-frame-transparent") / 100;
...
settings.connect('changed::the-circles-clock-frame-transparent', () => { settings_clock_frame_transparent = settings.get_int("the-circles-clock-frame-transparent") / 100; });
